<template>
    ...
    <el-tabs v-model="activeName" class="demo-tabs"  @tab-click="handleClick">
        <el-tab-pane label="说明书列表" name="filelist"  > 
            <div class="column">
            <div class="column-left">
                ...
                <el-table :data="tableData" style="width:100%;min-width:400px; " :show-overflow-tooltip="true" @row-click="rowClick">
                    <el-table-column prop="infoname" label="说明书名称" min-width="30%" >
                           <template #header>
                        ...
                        <a  style="text-decoration:none; color:rgb(64,158,255); " :href="'/info/download?path=Info/'+scope.row.infoname" :download="scope.row.infoname">
                    ...
                    <el-table-column prop="updatetime" label="上传时间" min-width="20%" >
                     ...
                     <el-table-column prop="downloadtime" label="下载" min-width="5%" style="text-align:center;" />
                    <el-table-column fixed="right" label="操作" min-width="20%" style="text-align:center;">
                       <template #header>
        ...
        <el-tab-pane label="上传说明书" name="upload" >
            <uploadinfovue></uploadinfovue>
