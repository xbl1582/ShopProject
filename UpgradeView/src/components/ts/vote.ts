...
import uploadvotevue from "../uploadvotevue.vue"
       ...
       rowClick(row){
            ...
            switch (row.type) {
                case "jpg":{
                    ...
                    setTimeout( function(){
                         //@ts-ignore
                       _this.$refs.child.setimagepath("/vote/image?path="+row.votename);
                        //@ts-ignore
                       _this.loading=false;
                        }, 1500)
                ...
                case "tif":{
                    ...
                    setTimeout( function(){
                         //@ts-ignore
                       _this.$refs.child.setimagepath2("/vote/image?path="+row.votename);
                        //@ts-ignore
                       _this.loading=false;
                        }, 1500)
                ...
                case "docx":{
                    ...
                    setTimeout( function(){
                         //@ts-ignore
                       _this.$refs.child.setwordpath("/vote/file?path="+row.votename);
                        //@ts-ignore
                       _this.loading=false;
                        }, 1500)
