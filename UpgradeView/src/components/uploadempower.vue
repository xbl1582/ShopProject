        ...
        <el-row>
            <el-col :span="24">
                ...
                :on-preview="handlePreview"
                    ...
                    :http-request="myUploadFile" accept=",.txt,.zip,.rar" multiple>

                    <svg t="1702281594898" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="9624" width="200" height="200">
                        <path
...
<script lang="ts" src="./ts/uploadempower.ts" >
